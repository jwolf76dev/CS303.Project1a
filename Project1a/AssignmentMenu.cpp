...
void assignmentMenu::displayAssignments(Ordered_List<assignment>& assignedList, Ordered_List<assignment>& completedList)
{
	...
	while (iter != assignedList.end()) {
		cout << iter->getDueDate() << ", " << iter->getDescription() << ", " << iter->getAssignDate() << ", " << iter->getStatus() << endl;
		++iter;
	}
...
void assignmentMenu::addAssignment(Ordered_List<assignment>& assignedList, Ordered_List<assignment>& completedList)
{
	...
	cout << "When was it assigned? (MM/DD/YYY)" << endl;
	cin >> assignedDate;

	// Prompt the user for the dueDate in MM/DD/YYYY format. 
	cout << "When's the due date? (MM/DD/YYY)" << endl;
	cin >> dueDate;
	cin.ignore(1);
...
void assignmentMenu::listLateAssignments(Ordered_List<assignment>& assignedList, Ordered_List<assignment>& completedList)
{
